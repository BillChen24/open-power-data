...
const chinaDemandDatasets: Dataset[] = [
  {
    ...
    size: "22 KB",
    license: "CC BY 4.0",
    citation: "Power Transformation Lab. (2026). China Provincial Annual Electricity Consumption [Dataset], Version 1.0. University of California, San Diego. [URL]. Licensed under CC BY 4.0.",
    about: "This dataset contains China provincial annual electricity consumption data. The data is collected from the National Bureau of Statistics of China (NBS).",
...
`,
  ...
  },
  {
    ...
    size: "37 KB",
    license: "CC BY 4.0",
    citation: "Power Transformation Lab. (2026). China Provincial Monthly Electricity Consumption [Dataset], Version 1.0. University of California, San Diego. [URL]. Licensed under CC BY 4.0.",
    about: "This dataset contains China provincial monthly electricity consumption data. The data is collected from Dianchacha.",
    regionLevel: "Provincial",
    frequency: "Monthly",
...
`,
  ...
  },
  {
    ...
    size: "11.4 MB",
    license: "CC BY 4.0",
    citation: "Power Transformation Lab. (2026). China Provincial Simulated Hourly Electricity Load Profiles (2022) [Dataset], Version 1.0. University of California, San Diego. [URL]. Licensed under CC BY 4.0.",
...
const chinaSupplyDatasets: Dataset[] = [
  {
    ...
    size: "3.3 MB",
    license: "CC BY 4.0",
    citation: "Power Transformation Lab. (2026). China Power Generators by Technology [Dataset], Version 1.0. University of California, San Diego. [URL]. Licensed under CC BY 4.0.",
    about: "This dataset contains data on China’s coal, gas, hydro, nuclear, solar and wind power generators. The data is collected from Global Energy Monitor (GEM).",
    regionLevel: "Provincial",
    frequency: "N/A",
...
`,
  ...
  },
  {
    ...
    size: "85 KB",
    license: "CC BY 4.0",
    citation: "Power Transformation Lab. (2026). China Provincial Annual Electricity Generation by Technology [Dataset], Version 1.0. University of California, San Diego. [URL]. Licensed under CC BY 4.0.",
    about: "This dataset contains China provincial annual electricity generation data, including total, thermal and hydro data. The data is collected from the National Bureau of Statistics of China (NBS).",
    regionLevel: "Provincial",
    frequency: "Annual",
...
`,
  ...
  },
  {
    ...
    size: "694 KB",
    license: "CC BY 4.0",
    citation: "Power Transformation Lab. (2026). China Provincial Monthly Electricity Generation by Technology [Dataset], Version 1.0. University of California, San Diego. [URL]. Licensed under CC BY 4.0.",
    about: "This dataset contains China provincial monthly electricity generation data, including total, thermal, hydro, nuclear, solar and wind data. The data is collected from the National Bureau of Statistics of China (NBS).",
    regionLevel: "Provincial",
    frequency: "Monthly",
...
`,
  ...
  },
  {
    ...
    size: "46 KB",
    license: "CC BY 4.0",
    citation: "Power Transformation Lab. (2026). China Provincial Annual Installed Capacity by Technology [Dataset], Version 1.0. University of California, San Diego. [URL]. Licensed under CC BY 4.0.",
    about: "This dataset contains China provincial annual installed capacity data in the power industry, including thermal, hydro, nuclear, solar and wind data. The data is collected from Dianchacha.",
    regionLevel: "Provincial",
    frequency: "Annual",
...
`,
  ...
  },
  {
    ...
    size: "94 KB",
    license: "CC BY 4.0",
    citation: "Power Transformation Lab. (2026). China Provincial Annual Solar PV Grid-Connected Capacity by Type [Dataset], Version 1.0. University of California, San Diego. [URL]. Licensed under CC BY 4.0.",
    about: "This dataset contains China provincial annual grid-connected capacity data by solar PV type, including new and cumulative, distributed and centralized, and residential and non-residential solar PV data. The data is collected from the National Energy Administration of China (NEA).",
    regionLevel: "Provincial",
    frequency: "Annual",
...
`,
  ...
  },
  {
    ...
    size: "23 KB",
    license: "CC BY 4.0",
    citation: "Power Transformation Lab. (2026). China Provincial Monthly Solar PV Installed Capacity [Dataset], Version 1.0. University of California, San Diego. [URL]. Licensed under CC BY 4.0.",
    about: "This dataset contains China provincial monthly solar PV installed capacity data. The data is collected from PK Thinker.",
    regionLevel: "Provincial",
    frequency: "Monthly",
...
`,
  ...
  },
  {
    ...
    size: "23 KB",
    license: "CC BY 4.0",
    citation: "Power Transformation Lab. (2026). China Provincial Monthly Wind Power Installed Capacity [Dataset], Version 1.0. University of California, San Diego. [URL]. Licensed under CC BY 4.0.",
    about: "This dataset contains China provincial monthly wind power installed capacity data. The data is collected from PK Thinker.",
    regionLevel: "Provincial",
    frequency: "Monthly",
    dataCoverage: "2022/05-2025/07",
    downloadUrl: "#",
...
const chinaParametersDatasets: Dataset[] = [
  {
    ...
    size: "293 KB",
    license: "CC BY 4.0",
    citation: "Power Transformation Lab. (2026). China Coal Price Indices [Dataset], Version 1.0. University of California, San Diego. [URL]. Licensed under CC BY 4.0.",
    about: "This dataset contains data on several key coal price indices in China, such as BSPI, CCI, and CCTD. The data was collected from multiple data sources, including the China Coal Transport and Distribution Association and the China Coal Economic Research Association.",
...
const vietnamDemandDatasets: Dataset[] = [
  {
    ...
    size: "1 KB",
    license: "CC BY 4.0",
    citation: "Power Transformation Lab. (2026). Vietnam Regional Annual Electricity Consumption [Dataset], Version 1.0. University of California, San Diego. [URL]. Licensed under CC BY 4.0.",
